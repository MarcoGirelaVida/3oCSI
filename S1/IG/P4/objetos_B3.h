...
typedef enum{POINTS,EDGES,SOLID,SOLID_COLORS,
             SOLID_PHONG_FLAT,SOLID_PHONG_GOURAUD,SOLID_TEXTURE} _modo;
...
int invertir_n;                // 1 en caso de invertir direcciones normales
};
...
{
public:
       _esfera(float radio=1.0, int latitud=12, int longitud=12);
};
