...
// valores por defecto en todos los objetos
ambiente=_vertex4f(0.8,0.0,0.2,1.0);   //coeficientes ambiente 
difuso=_vertex4f(0.8,0.0,0.2,1.0);     //coeficientes difuso
especular=_vertex4f(0.5,0.5,0.5,1.0);  //coeficiente especular
brillo=80;                            //exponente del brillo 
}
...
cubo.ambiente=_vertex4f(0.0,0.4,0.8,1.0);   //coeficientes ambiente 
cubo.difuso=_vertex4f(0.0,0.4,0.8,1.0);     //coeficientes difuso
cubo.especular=_vertex4f(0.5,0.5,0.5,1.0);  //coeficiente especular
cubo.brillo=10;                              //exponente del brillo 
